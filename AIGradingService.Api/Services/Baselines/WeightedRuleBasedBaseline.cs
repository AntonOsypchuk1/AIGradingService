...
public class WeightedRuleBasedBaseline : IEvaluationBaseline
{
    public string Name => "weighted_rule_based";
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var riskFlags = BuildRiskFlags(testRun, submission.StudentCode, weightedPassRate);
        ...
        var grade = new EvaluationGrade
        {
            ...
            [
                ...
                new CriterionScore
                {
                    ...
                    MaxScore = 3,
                    Explanation = "Estimated from weighted test coverage and solution structure."
                },
                new CriterionScore
                {
                    Name = "code_quality",
        ...
        double passRate)
    {
        ...
        if (passRate < 1)
            riskFlags.Add("failed_weighted_tests");
